                        ...
                        <tbody>
                            <%
                                try {
                                    ...
                                    String q = "select * from orderd where status='active'";
                            ...
                            <tr>
                                ...
                                <td><a href="bill.jsp?id=<%= rs.getString("order_id")%>" target="_blank"><i class="fa fa-edit" style="font-size: 22px"></i></a>&nbsp |&nbsp
